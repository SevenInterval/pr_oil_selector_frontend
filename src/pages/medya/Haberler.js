    ...
    return (
        <>
            <Helmet>
                ...
                <link rel='canonical' href="/news/category/haberler" />
            </Helmet>
                        ...
                        {currentPage === 1 &&
                            <>
                                <Haber uri={"/news/harika-haberler-teodor-tsvetkovtan-bulgaristandaki-texaco-marka-elcimizden"}
                                    ...
                                    lastClassName={""} />
                                <Haber uri={"/news/prista-oil-holding-yaglayicilar-surdurulebilirlik-forumunun-bir-parcasiydi"}
                                    gorsel={SurdurulebilirlikNewImage}
                                    baslik={"Prista Oil Holding, Yağlayıcılar Sürdürülebilirlik Forumu’nun bir Parçasıydı."}
                                    tarih={"01-03-2024"}
                                    detay={"                                    Kasım 2023 ayının sonlarına doğru, Prista Oil Holding, Yağlayıcı sanayinde sürdürülebilirlik uygulamalarını ilerletmeye adanmış Berlin, Almanya’da düzenlenen çığır açan bir etkinlik olan Yağlayıcı Sürdürülebilirlik Forumu’na katıldı.                                "}
                                    lastClassName={"last"} />
