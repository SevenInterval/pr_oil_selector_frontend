...
const RusyaHaber = () => {
    return (
        <>
            <Helmet>
                <title>Rusçuk, Bulgaristan’da 7 Eylül’de gerçekleşen PRISTA®’NIN ...</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/ruscuk-bulgaristanda-7-eylulde-gerceklesen-prista-r-nin-rusyadaki-distributorleri-icin-ilk-konferansinda-fikir-ve-deneyim-alisverisi-yapildi" />
            </Helmet>
                                ...
                                >
                                    <li id="galley_image_100">
                                        ...
                                        <a data-fancybox="gallery" href={RusDistImage}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage} />
                                        </a>
                                    </li>
                                    <li id="galley_image_101">

                                        <a data-fancybox="gallery" href={RusDistImage2}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage2} />
                                        </a>
                                    </li>
                                    <li id="galley_image_102">

                                        <a data-fancybox="gallery" href={RusDistImage3}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage3} />
                                        </a>
                                    </li>
                                    <li id="galley_image_103">

                                        <a data-fancybox="gallery" href={RusDistImage4}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage4} />
                                        </a>
                                    </li>
                                    <li id="galley_image_104">

                                        <a data-fancybox="gallery" href={RusDistImage5}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage5} />
                                        </a>
                                    </li>
                                    <li id="galley_image_105">

                                        <a data-fancybox="gallery" href={RusDistImage6}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={RusDistImage6} />
                                        </a>
                                    </li>
                                </FancyBox>
                            </ul>
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">Rusçuk, Bulgaristan’da 7 Eylül’de gerçekleşen PRISTA®’NIN RUSYA’DAKİ DİSTRİBÜTÖRLERİ İÇİN İLK KONFERANSINDA fikir ve deneyim alışverişi yapıldı</span>
