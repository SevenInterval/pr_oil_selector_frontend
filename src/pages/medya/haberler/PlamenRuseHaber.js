...
const PlamenRuseHaber = () => {
    return (
        <>
            <Helmet>
                <title>Plamen Bobokov: Ruse sadece kalbimde değil, aynı zamanda ...</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/plamen-bobokov-ruse-sadece-kalbimde-degil-ayni-zamanda-gelecekteki-tum-projelerimde-yer-aliyor" />
            </Helmet>
