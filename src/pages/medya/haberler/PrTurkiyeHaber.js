                            ...
                            >
                                <li id="galley_image_22">
                                    <a data-fancybox="gallery" href={PrTurkiyeImage1}>
                                        <img title="n.jpg" alt="n.jpg" width="360" src={PrTurkiyeImage1} />
                                    </a>
                                </li>
                                <li id="galley_image_23">
                                    <a data-fancybox="gallery" href={PrTurkiyeImage2}>
                                        <img title="n.jpg" alt="n.jpg" width="360" src={PrTurkiyeImage2} />
                                    </a>
                                </li>
                                <li id="galley_image_24">
                                    <a data-fancybox="gallery" href={PrTurkiyeImage3}>
                                        <img title="n.jpg" alt="n.jpg" width="360" src={PrTurkiyeImage3} />
                                    </a>
                                </li>
                                <li id="galley_image_25">
                                    <a data-fancybox="gallery" href={PrTurkiyeImage4}>
                                        <img title="n.jpg" alt="n.jpg" width="360" src={PrTurkiyeImage4} />
                                    </a>
                                </li>
                            </FancyBox>
                        </ul>
                        <h3 className="hs-small">PRISTA OIL TÜRKİYE, İSTANBUL'Kİ AUTOMECHANIKA TİCARET FUARINA KATILIYOR</h3>
