...
const MonzaHaber = () => {
    return (
        <>
            <Helmet>
                <title>Monza taraftarları Bulgar takımını “Sofia Car Motorsport...</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/monza-taraftarlari-bulgar-takimini-sofia-car-motorsport-ve-aracin-yaraticisi-rosen-daskalov-u-en-iyi-ekip-ve-araci-da-pistteki-en-hizli-arac-olarak-anons-ettiler" />
            </Helmet>
                                ...
                                >
                                    <li id="galley_image_29">
                                        <a data-fancybox="gallery" href={MonzaImage1}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonzaImage1} />
                                        </a>
                                    </li>
                                    <li id="galley_image_30">
                                        <a data-fancybox="gallery" href={MonzaImage2}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonzaImage2} />
                                        </a>
                                    </li>
                                    <li id="galley_image_31">
                                        <a data-fancybox="gallery" href={MonzaImage3}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonzaImage3} />
                                        </a>
                                    </li>
                                    <li id="galley_image_32">
                                        <a data-fancybox="gallery" href={MonzaImage4}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonzaImage4} />
                                        </a>
                                    </li>
                                    <li id="galley_image_33">
                                        <a data-fancybox="gallery" href={MonzaImage5}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonzaImage5} />
                                        </a>
                                    </li>
                                </FancyBox>
                            </ul>
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">Monza taraftarları Bulgar takımını “Sofia Car Motorsport” ve aracın yaratıcısı Rosen Daskalov'u en iyi ekip ve aracı da pistteki en hızlı araç olarak anons ettiler</span>
