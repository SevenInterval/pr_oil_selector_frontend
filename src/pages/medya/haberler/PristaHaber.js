...
const PristaHaber = () => {
    return (
        <>
            <Helmet>
                <title>PRISTA OIL GRUBU: YENİDEN YAPILANIYOR</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/prista-oil-grubu-yeniden-yapilaniyor" />
            </Helmet>
                                ...
                                <li id="galley_image_183">
                                    ...
                                    >
                                        <a data-fancybox="gallery" href={PristaOil}>
                                            <img title="pristaHaberImg" alt="pristaHaberImage" width={360} height={270} loading="eager" src={PristaOil} />
                                        </a>
                                    </FancyBox>
                                </li>
                            </ul>
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">PRISTA OIL GRUBU: YENİDEN YAPILANIYOR</span>
