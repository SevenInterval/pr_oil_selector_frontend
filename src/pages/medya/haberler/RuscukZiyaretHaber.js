...
const RuscukZiyaretHaber = () => {
    return (
        <>
            <Helmet>
                <title>INTER CARS EKİBİ RUSÇUK, BULGARİSTAN'DAKİ PRISTA OIL KARIŞTIRMA..</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/inter-cars-ekibi-ruscuk-bulgaristan-daki-prista-oil-karistirma-tesisini-ziyaret-etti" />
            </Helmet>
                                ...
                                >
                                    <li id="galley_image_66">
                                        <a data-fancybox="gallery" href={RuscukHaberImage}>
                                            <img title="ruscukImg" alt="ruscukImage" width={360} height={270} src={RuscukHaberImage} loading="eager"/>
                                        </a>
                                    </li>
                                    <li id="galley_image_67">
                                        <a data-fancybox="gallery" href={RuscukHaberImage2}>
                                            <img title="ruscukImg2" alt="ruscukImage2" width={360} height={270} src={RuscukHaberImage2} loading="eager"/>
                                        </a>
                                    </li>
                                </FancyBox>
                            </ul>
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">INTER CARS EKİBİ RUSÇUK, BULGARİSTAN'DAKİ PRISTA OIL KARIŞTIRMA TESİSİNİ ZİYARET ETTİ</span>
