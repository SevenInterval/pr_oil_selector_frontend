...
const BayilikHakkinda = () => {
    ...
    return (
        <>
            <Helmet>
                <title>YOL ARKADAŞIMIZ OL KAZANCIN YAĞ GİBİ AKSIN!</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/yol-arkadasimiz-ol-kazancin-yag-gibi-aksin-1" />
            </Helmet>
                ...
                <article>
                    <div className="page-header">
                        ...
                        <div className="news-detail">
                            ...
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">YOL ARKADAŞIMIZ OL KAZANCIN YAĞ GİBİ AKSIN!</span>
