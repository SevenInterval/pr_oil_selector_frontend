...
const MonteCarloHaber = () => {
    return (
        <>
            <Helmet>
                <title>SIN CARS İngiltere, yılın en görkemli etkinliklerinden biri ...</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/sin-cars-ingiltere-yilin-en-gorkemli-etkinliklerinden-biri-olan-ve-her-yil-ihtisamin-baskenti-monte-carlo-da-prens-ii" />
            </Helmet>
                                ...
                                >
                                    <li id="galley_image_74">
                                        <a data-fancybox="gallery" href={MonteCarloHaber1}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber1} />
                                        </a>
                                    </li>
                                    <li id="galley_image_75">
                                        <a data-fancybox="gallery" href={MonteCarloHaber2}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber2} />
                                        </a>
                                    </li>
                                    <li id="galley_image_76">
                                        <a data-fancybox="gallery" href={MonteCarloHaber3}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber3} />
                                        </a>
                                    </li>
                                    <li id="galley_image_77">
                                        <a data-fancybox="gallery" href={MonteCarloHaber4}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber4} />
                                        </a>
                                    </li>
                                    <li id="galley_image_78">
                                        <a data-fancybox="gallery" href={MonteCarloHaber5}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber5} />
                                        </a>
                                    </li>
                                    <li id="galley_image_79">
                                        <a data-fancybox="gallery" href={MonteCarloHaber6}>
                                            <img title="n.jpg" alt="n.jpg" width={360} height={270} loading="eager" src={MonteCarloHaber6} />
                                        </a>
                                    </li>
                                </FancyBox>
                            </ul>
                            <span style={{ verticalAlign: "sub", color: "#000" }} className="hs-small">SIN CARS İngiltere, yılın en görkemli etkinliklerinden biri olan ve her yıl ihtişamın başkenti Monte Carlo'da Prens II</span>
