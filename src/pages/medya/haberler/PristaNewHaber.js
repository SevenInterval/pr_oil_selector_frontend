                    ...
                    <div className="news-detail">
                        ...
                        <table align="left" border="0" cellPadding="0" cellSpacing="4" style={{ width: "700px" }}>
                            <tbody>
                                <tr>
                                    <td>
                                        <p><img alt="checkImage" src={CheckImage} style={{ height: "31px", width: "30px" }} /></p>
                                    </td>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}>Baz yağ üreticileri</span></p>
                                    </td>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="checkImage" src={CheckImage} style={{ height: "31px", lineHeight: "20.8px", width: "30px" }} /></span></p>
                                    </td>
                                    <td>
                            ...
                            <tbody>
                                <tr>
                                    <td style={{ width: "170px" }}>
                                        <p><img alt="nspo1Image" src={Nspo1Image} style={{ height: "238px", width: "150px" }} /></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
                                ...
                                <tr>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="nspo2Image" src={Nspo2Image} style={{ height: "237px", width: "150px" }} /></span></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
                                ...
                                <tr>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="nspo3Image" src={Nspo3Image} style={{ height: "237px", width: "150px" }} /></span></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
                                ...
                                <tr>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="nspo4Image" src={Nspo4Image} style={{ height: "237px", width: "150px" }} /></span></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
                                ...
                                <tr>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="nspo5Image" src={Nspo5Image} style={{ height: "237px", width: "150px" }} /></span></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
                                ...
                                <tr>
                                    <td>
                                        <p><span style={{ fontSize: "16px" }}><img alt="nspo6Image" src={Nspo6Image} style={{ height: "237px", width: "150px" }} /></span></p>
                                    </td>
                                    <td>
                                        <p>&nbsp;</p>
