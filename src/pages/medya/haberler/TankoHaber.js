...
const TankoHaber = () => {
    return (
        <>
            <Helmet>
                <title>Plamen Bobokov ve mimar Tanko Serafimov'a (ölümünden sonra)...</title>
                <meta name="description"
                    content="PRISTA Oil Group is a holding company whose field of activity covers the following areas: Production of motor and industrial oils, greases and specialty fluids" />
                <link rel='canonical' href="/news/plamen-bobokov-ve-mimar-tanko-serafimov-a-olumunden-sonra-ruse-nin-saygin-vatandasi-unvani-verildi" />
            </Helmet>
