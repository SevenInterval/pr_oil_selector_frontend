    ...
    return (
        <>
            <Helmet>
                ...
                <link rel='canonical' href="/bulgaristan" />
            </Helmet>
                            ...
                            <div className="col-md-4">
                                ...
                                <p>
                                    <Link to="https://www.facebook.com/PristaOil/" target="_blank">
                                        <img alt="facebookIcon" src={F_icon} height={25} width={25} loading="eager" title="faceIc" /></Link>&nbsp;&nbsp;
                                    <Link to="https://www.youtube.com/channel/UCdijTVNCAy9gYh7--64NRNQ/featured" target="_blank">
                                        <img alt="youtubeIcon" src={Y_icon} height={25} width={25} loading="eager" title="youtubeIc" />
                                    </Link>
                                </p>
                            </div>
                            <div className="col-md-4">
