                ...
                <div className="page-article">
                    <p>
                        <Link to={PdfAKREDITACIA} target="_blank">
                            <img alt="akreditacia.21.06.2022" src={PdfImage}
                                style={{ borderStyle: "solid", borderWidth: "1px", float: "right", height: "424px", marginLeft: "10px", marginRight: "10px", width: "300px" }} />
                        </Link>
                    </p>
