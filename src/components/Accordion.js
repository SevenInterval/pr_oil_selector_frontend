const Accordion = (props) => {
    ...
    return (
        <div id="object-list" className="faq-object-list ui-accordion ui-widget ui-helper-reset" role="tablist">
            <h2 onClick={() => changeActiveAccordion(changeAcc)}
                ...
                <span className={activeAccordion === changeAcc ? "ui-accordion-header-icon ui-icon ui-icon-triangle-1-s" : "ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"}></span>{question}
            </h2>
