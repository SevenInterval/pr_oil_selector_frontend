...
const SideBarUrunler = (props) => {
    const { level1ShowName, level2ShowName } = props;
    const [openSideBar, setOpenSideBar] = useState(false);

    return (
        <aside style={openSideBar ? { height: "466px", transition: "0.4s" } : { height: "40px", transition: "0.4s" }} className={openSideBar ? "active" : ""}>
                    ...
                    <li className="level-0 node-77 show">
                        ...
                        <ul className="sub show">
                            <li className="level-1 node-97">
                                <Link to="/catalogue/yuksek-performansli-dpf-twc">OTOMOTİV</Link>
                                {level1ShowName === "OTOMOTIV" ?
                                    <ul className={level1ShowName === "OTOMOTIV" ? "sub show" : "sub"}>
                                        <li className="level-2 node-98">
                                            <Link to="/catalogue/yuksek-performansli-dpf-twc">PCMO</Link>
                                        ...
                                        <li className="level-2 node-103">
                                            <Link to="/catalogue/yuksek-performansli-dpf-twc-uyumlu">HDMO</Link>
                                        ...
                                        <li className="level-2 node-108">
                                            <NavLink to="/catalogue/gaz-motor-yaglari">GAZ MOTOR YAĞLARI</NavLink>
                                        </li>
                                        <li className="level-2 node-109">
                                            <NavLink to="/catalogue/2t-4t-yaglari">2T/4T YAĞLARI</NavLink>
                                        </li>
                                        <li className="level-2 node-110">
                                            <Link to="/catalogue/yuksek-performansli-duz-sanziman">ŞANZIMAN</Link>
                                        ...
                                        <li className="level-2 node-115">
                                            <Link to="/catalogue/sogutma-sulari">ÖZEL AKIŞKANLAR</Link>
                            ...
                            <li className="level-1 node-120">
                                <Link to="/catalogue/hidrolik-ve-kizak-yaglari">ENDÜSTRİYEL ÜRÜNLER</Link>
                                {level1ShowName === "ENDUSTRI" ?
                                    <ul className={level1ShowName === "ENDUSTRI" ? "sub show" : "sub"}>
                                        ...
                                        <li className="level-2 node-130">
                                            <Link to="/catalogue/sade-yaglar">MWF</Link>
                                        ...
                                        <li className="level-2 node-133">
                                            <Link to="/catalogue/plastiklestiriciler">İŞLEM YAĞLARI</Link>
                            ...
                            <li className="level-1 node-137">
                                <NavLink to="/catalogue/gresler">GRESLER</NavLink>
                            </li>
                            <li className="level-1 node-141">
                                <Link to="/catalogue/sistem-yaglari">MARİN YAĞLARI</Link>
                                {level1ShowName === "MARIN" ?
                                    <ul className={level1ShowName === "MARIN" ? "sub show" : "sub"}>
                                        <li className="level-2 node-142">
                                            <Link to="/catalogue/sistem-yaglari">ANA YAĞLAR</Link>
                                        ...
                                        <li className="level-2 node-146">
                                            <Link to="/catalogue/disli-yaglari">YARDIMCI YAĞLAR</Link>
            ...
            <div className="aside-show-button" onClick={() => setOpenSideBar(!openSideBar)}>Product Portfolio</div>
        </aside>
    )
}
