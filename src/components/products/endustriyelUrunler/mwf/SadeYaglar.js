            ...
            <div className="body_with_sidebar catalog">
                ...
                <article>
                    ...
                    <ul className="objects-list-two-rows">
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-rezinol-hd-22-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-rezinol-4"}
                            ...
                            last={true} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-c-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-frezol-ep-4"}
                            productLogo={basicVarilKucukImage} productName={"Prista Frezol EP"}
                            productText={"Yakında"}
                            last={true} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-frezol-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-mpd-4"}
                            ...
                            last={true} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-ee-5-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/sade-yaglar/prista-honing-4"}
