            ...
            <div className="body_with_sidebar catalog">
                ...
                <article>
                    ...
                    <ul className="objects-list-two-rows">
                        <UrunOzet productUrl={"/catalogue/sirkulasyon-yaglari-ve-genel-amacli-yaglar/prista-paper-machine-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/catalogue/sirkulasyon-yaglari-ve-genel-amacli-yaglar/prista-circulating-oil-4"}
                            ...
                            last={true} />
                        <UrunOzet productUrl={"/catalogue/sirkulasyon-yaglari-ve-genel-amacli-yaglar/prista-an-4"}
