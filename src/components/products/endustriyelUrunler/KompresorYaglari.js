            ...
            <div className="body_with_sidebar catalog">
                ...
                <article>
                    ...
                    <ul className="objects-list-two-rows">
                        <UrunOzet productUrl={"/product/kompresor-yaglari/prista-r-compressor-synth-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/kompresor-yaglari/prista-mvk-2-7"}
                            ...
                            last={true} />
                        <UrunOzet productUrl={"/product/kompresor-yaglari/prista-mvk-1-4"}
                            ...
                            last={false} />
                        <UrunOzet productUrl={"/product/kompresor-yaglari/prista-frigus-ha-7"}
